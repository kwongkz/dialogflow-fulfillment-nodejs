declare module "@kwong_cloude8/dialogflow-fulfillment" {
  import {
    Context,
  ...
  export class WebhookClient {
    ...
    public userAppId: string;

    public body: any;

    public file: { fileUrl: string; fileType: string };
    ...
    public handleRequest(
      handler:
        | Map<string, (agent: WebhookClient) => void>
     ...
     */
    public getContext(contextName: string): Context<Parameters>;
...
declare module "@kwong_cloude8/dialogflow-fulfillment/src/rich-responses/rich-response" {
